...
cells = [
 md("# utide-gpu on a real tide-gauge record",
    "",
 ...
 code("raw = np.loadtxt(\"can1998.dtf\")            # seconds year month day hour elev flag\n"
 ...
 md("## 2. Harmonic analysis on the GPU",
    "",
 ...
 code("coef = utide.solve(t, h, lat=-25, method=\"ols\", conf_int=\"linear\",\n"
 ...
 md("## 3. Prediction vs observations",
    "",
    "`reconstruct` predicts the tide from the fitted constituents."),
 code("tide = utide.reconstruct(t, coef, epoch=\"1998-01-01\", verbose=False)\n"
      "resid = h - tide.h\n"
 ...
 code("c = utide.tidal_characteristics(t, h)\n"
      ...
      "plt.legend(); plt.show()"),
 md("To analyse a whole **field** of stations like this at once — extracting",
