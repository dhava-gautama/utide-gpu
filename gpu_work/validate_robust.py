...
print(
    f"  iterations: cpu={c_cpu.rf.iterations} gpu-double={c_gd.rf.iterations} gpu-single={c_gs.rf.iterations}",
)
...
print(
    f"  time: cpu={1000*t_cpu:.0f}ms  gpu-double={1000*t_gd:.0f}ms ({t_cpu/t_gd:.1f}x)  "
