...
cells = [
 md("# The GPU batch use case on real data: 39 NOAA tide gauges",
    "",
 ...
 code("d = np.load(\"../examples/data/noaa_hourly_2023.npz\", allow_pickle=True)\n"
 ...
 md("## 2. One `solve_many` call for every station",
    "",
 ...
 code("kw = dict(lat=lat0, epoch=\"2023-01-01\", verbose=False)\n"
